...
% hablar de los APC (Automatic passenger counting)
    ...
    \item Bordes: Se refiere a límites socioeconómicos generados a partir de la agrupación de viajes que divide la ciudad en pequeños barrios que llamamos comunidades.
    \end{itemize}
