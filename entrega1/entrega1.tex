\documentclass[itshape,12pt]{article}
...
\usepackage{amsfonts} % para letras que representan conj numericos (R,Z,N,....)
    ...
    \newcommand*{\firma}[6]{
        ...
        \noindent\makebox[1.5in][l]{#1}\hfill
            ...
            \noindent\makebox[1.5in][l]{}\hfill
            \noindent\makebox[1.5in][l]{fhernand@dcc.uchile.cl}\hfill
            \noindent\makebox[1.5in][l]{}\hfill
            \noindent\makebox[1.5in][l]{}\hfill
            \noindent\makebox[1.5in][l]{09-90977379}\hfill
    }
...
\makebox[\textwidth]{\includegraphics[width=300pt]{./images/LogoFCFM.jpg}}
\end{figure}
\begin{center}
...
%\vspace*{\hfill
    ...
    \begin{center}
          ...
          \renewcommand{\section}[2]{} % elimina el titulo por default que pone thebibliography
              \begin{thebibliography}{99}

          %\setlength{\itemindent}{0.2in} % desplaza las líneas siguientes a la primera hacia la derecha.

              \bibitem{Estructura_urbana} \emph{Detecting the dynamics of urban structure through spatial network analysis.}
          ...
          \bibitem{Procesamiento_datos} \emph{Estimation of a disaggregate multimodal public transport Origin–Destination matrix from passive smartcard data from Santiago, Chile} 
          ...
          \bibitem{Forma_ciudad_moderna} \emph{Urban spatial structure} 
          ...
          \bibitem{Libro_visualizacion} \emph{Interactive Data Visualization: Foundations, Techniques, and Applications} 
