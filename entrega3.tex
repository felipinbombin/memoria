...
\begin{lstlisting}[breaklines=true, language=SQL, numbers=left, commentstyle=\color{green}, title=asd, caption=Instalacion de postgres, label=fig:instalar_postgres]
...
\begin{lstlisting}[breaklines=true, language=R, numbers=left, commentstyle=\color{green}, title=asd, caption=Instalacion de R, label=fig:instalar_R]
