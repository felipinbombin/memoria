...
donde $P_i$	es la probabilidad de ser visitada la comunidad $i$ y $P_k/P_i$ es la probabilidad de visitar el nodo $k$ dado que la comunidad $i$ es visitada. Además $M_i$ es la cantidad de nodos que contiene la comunidad $i$ y la división por $P_i$ que afecta a los $P_k$ cumple la función de normalizar.
