...
La tabla ESTACION\_METRO contiene 20 atributos, y al igual que la tabla PARADEROS, la mayoría de sus campos fueron agregados para la ejecución de análisis previos. Los atributos relevantes son descritos en la tabla \ref{tabla:estacion_metro}.
