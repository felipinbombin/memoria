...
donde $P_i$	es la probabilidad de la comunidad $m$ de ser visitado y $P_k/P_i$ es la probabilidad de que el nodo $k$, que es parte de la comunidad $M_i$ de ser visitado
	...
	\subsubsection{fenomeno de mundo pequeño}
		% hablar de mundo pequeño
    \newpage
...
Según todo lo anterior sumado a un modelo ...\todo{¿cómo se llama el modelo?} Munizaga y Palma (2002)\cite{Procesamiento_datos} son capaces de estimar cerca del 80\% de los datos utilizados. Dado que es necesario conocer esta información, se restringe la data al porcentaje de datos que forman parte del resultado exitoso.
